...
global_matrix = build_matrix(lst, hash_range=200, time=20, k=10)
#print(global_matrix)
probability = prob_dist(global_matrix, lst, hash_range=200, time=20, k=10)
#print(probability)
